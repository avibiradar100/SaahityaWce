...
const CarouselHome = () => {
  return (
    <Carousel autoplay={true} autoplayInterval={2000} pauseOnHover={false} wrapAround={true}>
      <img src="https://res.cloudinary.com/avicloud/image/upload/v1655480341/bt5_dmn7cu.jpg" alt='1' />
      ...
      <img src="https://res.cloudinary.com/avicloud/image/upload/v1655474645/b1_jsoqoc.jpg" alt='4' />
